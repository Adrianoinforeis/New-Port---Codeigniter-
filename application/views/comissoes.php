...
//   },
    {
      extend: 'excel',
      text: 'Exportar Excel',
      title: 'Relatório de projeção em Excel '
      
   },
   {
      extend: 'pdf',
      text: 'Exportar PDF',
      title: 'Relatório de projeção em PDF',
   ...
   },
   {
      extend: 'print',
      text: 'Imprimir',
       title: 'Relatório de projeção gerais',
...
<div class="contentpanel"><!--Início da classe geral-->
    <div id="page-wrapper">
        ...
        <div class="container-fluid nao-imprime" style="background-color: #fff; margin-bottom: 10%;">
            ...
            ?>
            <div class="col-sm-9">
                <form style="margin-bottom: 5%;" method="post" action="<?= base_url(); ?>Cadastrar/comissoes">  
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-2 form-group">
                            <button type="submit" class="btn btn-info" id="botao_filtro" disabled="" title="Filtrar"><i class="fa fa-filter" aria-hidden="true" title="Filtrar"></i> Filtrar</button>
                        </div>
                       <!--  <div class="col-md-2 form-group">
...
<!--            <div class="col-sm-3" style="text-align:right;margin-bottom: 4%;">
            ...
            <?php if ($dados_geral['dados_faturamento'] != null) { ?>
                ...
                <div class="col-md-12" id="faturamento">
                    ...
                    ?>
                    <legend class="legend" style="color: #cc0000;">PROJEÇÃO DO MÊS: <?php echo $valor; ?>, ANO: <?php echo $ano; ?></legend>
...
<!--                                         <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 10px;"><?php echo $item->fat_id;?></td>-->
                                ...
                                echo $item->dta_envio;
                                    ...
                                    <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 10px;"><?php echo $item->vidas; ?></td>
                                    
                                    <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 10px;"><?php echo number_format($item->vl_fatura, 2, ',', '.');?></td>
                                   
                                    <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 10px;"><?php if($item->percentual <> null && $item->percentual <> ''){echo $item->percentual.'%';}?></td>
                                    
                                    <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 10px;">
                                        <?php $valfatura = $item->vl_fatura; 
                                        $proj = ($item->percentual / 100 * $valfatura);
                                        $vlsoma = $proj+$valfatura;
                                        if($item->percentual  <> null && $item->percentual <> ''){
                                        echo number_format($vlsoma, 2, ',', '.');
                                        }
                                        ?>
                                    </td>
