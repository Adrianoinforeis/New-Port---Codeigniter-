                                ...
                                <div class="row fluid">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" maxlength="9" onkeyup="maskCep(this)" onclick="maskCep(this)" onkeypress="maskCep(this)" class="form-control campos_form" name="cep" id="cep" value="<?php echo $dados_geral['dados_beneficiario']->cep; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" onkeyup="maiuscula(this)" class="form-control campos_form" name="cidade" id="cep" value="<?php echo $dados_geral['dados_beneficiario']->cidade; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2" >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeyup="maiuscula(this)" name="endereco" id="endereco" class="form-control campos_form" value="<?php echo $dados_geral['dados_beneficiario']->endereco; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row fluid">
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="numero" id="endereco" class="form-control campos_form" value="<?php echo $dados_geral['dados_beneficiario']->numero; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="endereco" class="control-label">BAIRRO</label>
                                            <input type="text" onkeyup="maiuscula(this)" name="bairro" id="endereco" class="form-control campos_form" value="<?php echo $dados_geral['dados_beneficiario']->bairro; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="13" onkeyup="masktel(this)" onclick="masktel(this)" onkeypress="masktel(this)" name="telefone" id="endereco" class="form-control campos_form" value="<?php echo $dados_geral['dados_beneficiario']->telefone; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="endereco" class="control-label">CARTEIRINHA</label>
                                            <input type="text" name="carteirinha" id="" class="form-control campos_form" value="<?php echo $dados_geral['dados_beneficiario']->carteirinha; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                ...
                                <div class="row fluid">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="campos_form form-control mb15 cat" id="ncontratos" name="ncontratos" disabled="">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="campos_form form-control mb15 cat" id="operadoras" name="operadoras" disabled="">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input disabled="" onkeyup="maiuscula(this)" type="text" class="campos_form form-control" id="planos" name="nome_plano">                                               
                                        </div>                                                
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="valor" class="control-label">VALOR</label>
                                            <input disabled="" type="text" name="valor" class="dinheiro campos_form form-control" onkeyup="maiuscula(this)" id="valor">
                                        </div>
                                    </div>
                                </div>
                                <div class="row fluid">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled="" type="number" name="numero_carteir" class="campos_form form-control" onkeyup="maiuscula(this)" id="numero_carteir">
                                        </div>
                                    </div>
                                </div>
                                <div class="row fluid">
