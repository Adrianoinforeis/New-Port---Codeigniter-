        ...
        <div class="modal-content">
            ...
            <div class="panel-body panel-body-nopadding">
                <div class="col-md-12" style="margin-bottom: 5%;" >
                    ...
                    <form action="<?= base_url(); ?>Intranet/upload_contratos?url=<?= $url; ?>" method="post" enctype="multipart/form-data" id="caduser" name="caduser" data-toggle="validator" role="form">
