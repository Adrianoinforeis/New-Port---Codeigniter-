...
//FIM DA FUNÇÃO MASCARA MAIUSCULA
            ...
            <div class="col-md-12" id="minhaDiv">
                ...
                <legend class="legend">BENEFICIÁRIOS EM MOVIMENTAÇÃO</legend>
                <div class="col-md-12">
                        ...
                        <table id="example" class="table table-hidaction table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody> 
                                ...
                                foreach ($dados_geral['dados_beneficiario'] as $value) {
                                    ?>
                                     <tr>
                                    <td><a href="filtro_beneficiario?id=<?php echo $value->id_beneficiario; ?>" title="Editar beneficiário"><?php echo $value->nome_ben; ?></a></td>
