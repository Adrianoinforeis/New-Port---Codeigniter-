...
<div class="contentpanel"><!--Início da classe geral-->
    <div id="page-wrapper">
        ...
        <div class="container-fluid" style="background-color: #fff;">
            ...
            <!--Listando usuários-->
            <div class="col-md-12">
                <legend class="legend">Reembolsos</legend>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%"  align=center>
                        ...
                        <tbody> 
                            ...
                            <tr style="align-content: center;">
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $login_user;     ?>Consulta Médica</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $ativo_empresa;     ?>Em Análise</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $tipo_user;     ?>10/10/2017</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $adm_sistem;     ?>20</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $adm_sistem;     ?>YZ</td>
                                <td class="text-center">
                                    <form method="post" name="" id="" action="<?= base_url();?>Intranet/editar_usuario">   
                                        ...
                                        <button type="button" name="excluir_reg" id="excluir_reg"
                                         ...
                                         <button type="submit" value="" name="alterar_user" id="alterar_user" class="btn btn-xs btn-primary btn-mini" ><i class="fa fa-folder-open-o" aria-hidden="true"></i></button>
                                    </form>
                                </td>
                            </tr>
                             <tr style="align-content: center;">
