                                ...
                                <div class="row fluid">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input onkeyup="maiuscula(this)" type="text" class="form-control campos_form" name="cidade" id="cidade" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2" >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input onkeyup="maiuscula(this)" type="text" name="endereco" id="rua" class="form-control campos_form" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row fluid">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input onkeyup="maiuscula(this)" type="text" name="bairro" id="bairro" class="form-control campos_form" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="14" onkeyup="maskCel(this)" onclick="maskCel(this)" onkeypress="maskCel(this)" name="carteirinha" id="" class="form-control campos_form" value="">
                                        </div>
                                    </div>
                                     <div class="col-sm-3">
                                        <div class="form-group">
