                   ...
                   <!-- <input type="hidden" name="url" value="<?php //echo $url;     ?>">-->
                    ...
                    <div class="col-md-12">
                        ...
                        if ($dados_geral['dados_atendimento']->analista == $user_logado && ($dados_geral['dados_atendimento']->andamento != 'FINALIZADO')) {
                            ?>
                            <button name="dados" value="dados" style="float: left;" class="btn btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> GRAVAR DADOS</button>
               ...
               <!-- <input type="hidden" name="url" value="<?php //echo $url;    ?>">-->
                ...
                if ($session_logado[0]->tipo_acesso == 'Colaborador') {
                    ...
                    <div class="col-md-12">   
                        ...
                        if ($dados_geral['dados_atendimento']->analista == $user_logado && ($dados_geral['dados_atendimento']->andamento != 'FINALIZADO')) {
                            ?>
                            <button onclick="funcao()" type = "submit" style="float: right;" name = "btn_abcham" class = "btn btn-danger" onclick="redirecionar();"><i class="fa fa-check-circle" aria-hidden="true"></i> FINALIZAR</button>                      
                        <?php } else { ?>
                            <button onclick="funcao()" disabled="" type = "submit" style="float: right;" name = "btn_abcham" class = "btn btn-danger" onclick="redirecionar();"><i class="fa fa-check-circle" aria-hidden="true"></i> FINALIZAR</button> 
                        <?php } ?>
                    </div>
                <?php } ?>
            </form>
