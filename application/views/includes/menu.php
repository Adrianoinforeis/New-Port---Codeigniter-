            ...
            <ul class="children">
               ...
               <ul class="children">
                 ...
                 <li><a href="<?= base_url()?>Intranet/relatorio_faturamentos">
                  ...
                  <?php 
                $user_permissaor = $session_logado[0]->permissao;
                if ($user_permissaor == 'Administrador') {
                    ?>
                 <li><a href="<?= base_url()?>Intranet/comissoes">
                        <i class="fa fa-caret-right"></i>COMISSÕES</a>
                 </li> 
                <?php }?>
               </ul>
                </li> 
