    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid" style="background-color: #fff;">
            ...
            <div class="col-md-12">
                ...
                <p></p>
                <p></p>
                <legend class="legend">Clientes cadastrados</legend>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $no_user;    ?>XPTO</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $login_user;    ?>XPTO LTDA</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $ativo_empresa;    ?>20.016.688/0001-05</td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $adm_sistem;    ?>(11) </td>
                                <td style="height: 0px; margin-bottom: 1px; margin-top: 1px; padding-bottom: 1px; padding-top: 3px; font-size: 11px;"><?php //echo $adm_sistem;    ?>e-mail@e-mail.com.br</td>
