...
<div class="contentpanel"><!--Início da classe geral-->
    <div id="page-wrapper">
        ...
        <div class="container-fluid" style="background-color: #fff; margin-bottom: 10%;">
            ...
            <div class="col-sm-6">
                <form style="margin-bottom: 5%;" method="post">   
...
//FIM DA FUNÇÃO MASCARA MAIUSCULA
            ...
            <div class="col-md-12" id="minhaDiv">
                <legend class="legend">PLANOS</legend>
                ...
                <div class="col-md-12" style="margin-bottom: 2%;">
                    ...
                    <form action="<?= base_url(); ?>cadastrar/cadastro_de_planos?url=<?= $url; ?>" method="post" enctype="multipart/form-data" id="caduser" name="caduser" data-toggle="validator" role="form">
                        ...
                        <input type="hidden" name="id_planos" value="<?php echo $dados_geral['dados_planos']->id_planos; ?>">
                                ...
                                <div class="row fluid">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control campos_form" name="id_operadoras">
                                                <option value="<?php echo $dados_geral['dados_planos']->id_operadoras; ?>"><?php echo $dados_geral['dados_planos']->nome_op; ?></option>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="controls form-group">
                                            ...
                                            <input type="text" name="pl_nome" id="nome" class="form-control campos_form" required value="<?php echo $dados_geral['dados_planos']->pl_nome; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="controls form-group">
                                            <label for="nome" class="control-label">DESCRIÇÃO</label>
                                            <input type="text" name="pl_descricao" id="nome" class="form-control campos_form" required value="<?php echo $dados_geral['dados_planos']->pl_descricao; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="razao" class="control-label">VALOR</label>
                                            <input type="text" name="pl_valor" id="razao" class="form-control campos_form dinheiro" value="<?php echo $dados_geral['dados_planos']->pl_valor; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="obs" id="obs" class="form-control campos_form"><?php echo $dados_geral['dados_planos']->obs; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
